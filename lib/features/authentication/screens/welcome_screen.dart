      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              AppColors.welcomeStart,
              AppColors.welcomeMid1,
              AppColors.welcomeMid2,
              AppColors.welcomeEnd,
            ],
          ),
        ),
        child: SafeArea(
            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: 15, color: Colors.white.withOpacity(0.65), height: 1.6),
                ),
                const Spacer(),
                _WhiteButton(
                  label: AppStrings.citizenLogin,
                  icon: Icons.login_rounded,
                  onTap: () => Navigator.pushNamed(context, AppRoutes.login),
                ),
                const SizedBox(height: 12),
                CustomButton(
                  label: AppStrings.authorityLogin,
                ...
                CustomButton(
                  ...
                  variant: ButtonVariant.ghostWhite,
    ...
    return Row(
      children: [
        ...
        Padding(
          ...
          child: Text('NEW HERE?', style: TextStyle(fontSize: 12, color: Colors.white.withOpacity(0.4), fontWeight: FontWeight.w500)),
        ),
        Expanded(child: Divider(color: Colors.white.withOpacity(0.15), thickness: 1)),
      ],
    );
